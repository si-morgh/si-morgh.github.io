...
images:
  - file: 1.png
    title: "Untitled Piece 1"
  - file: 2.png
    title: "Untitled Piece 2"
---
    ...
    <div class="carousel-slide" id="carouselSlide">
      <div class="art-item statement-slide">
        <div class="statement-card">
          <p>{{ site.data.statements.c2.text }}</p>
        </div>
      </div>

      {% for img in page.images %}
        <div class="art-item">
          <img src="{{ '/assets/images/art/collections/C2/' | append: img.file | relative_url }}" alt="{{ img.title }}">
