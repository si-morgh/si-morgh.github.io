...
<div style="display: flex; align-items: flex-start;">
  <div style="flex: 0.85; padding-right: 20px;">
    ...
    <p>I maintain the community website of <a href="https://impanset.github.io" target="_blank">IMPAN Pure Set Theory</a>.</p>
    <div style="height: 0.5cm;"></div>
  </div>
  
  <div style="flex: 0.15;">
    <img src="{{ '/assets/images/portrait.png' | relative_url }}" alt="My Image" style="max-width: 100%; height: auto;" />
